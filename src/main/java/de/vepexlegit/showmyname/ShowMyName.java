package de.vepexlegit.showmyname;
...
@Mod(modid = "showmyname", version = "1.0")
public class ShowMyName {
    ...
    public void onRenderPlayerPre(RenderPlayerEvent.Pre event) {
        ...
        if (player == mc.thePlayer) {
            ...
            GlStateManager.rotate(-mc.thePlayer.rotationYaw + (mc.gameSettings.thirdPersonView == 2 ? 180.0F : 0.0F), 0.0F, 1.0F, 0.0F);
            GlStateManager.rotate(mc.thePlayer.rotationPitch, mc.gameSettings.thirdPersonView == 2 ? -1.0F : 1.0F, 0.0F, 0.0F);
